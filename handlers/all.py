...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس ", url="t.me/rrrbe")],[InlineKeyboardButton("تواصل السورس ", url="t.me/tt33Bot")],[InlineKeyboardButton("شروحات السورس ", url="t.me/ZZ55E")]])
