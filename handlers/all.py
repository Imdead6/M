...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("Team Mallorca", url="t.me/rrrbe")],[InlineKeyboardButton("TwS Source", url="t.me/tt33Bot")],[InlineKeyboardButton("Source Explanantions", url="t.me/ZZ55E")]])
