...
LuaTele.sendText(msg_chat_id,msg_id,'*℘︙عدد احصائيات البوت الكامله \n˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖ ℘ ˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖\n℘︙عدد المجموعات : '..(Redis:scard(Mallorca..'Mallorca:ChekBotAdd') or 0)..'\n℘︙عدد المشتركين : '..(Redis:scard(Mallorca..'Mallorca:Num:User:Pv') or 0)..'*',"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'℘︙عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(Mallorca..'Mallorca:Num:Add:Bot'),"md",true)  
end
...
LuaTele.sendText(msg_chat_id,msg_id,'℘︙عدد رسائلك هنا *~ '..(Redis:get(Mallorca..'Mallorca:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'℘︙عدد التعديلات هنا *~ '..(Redis:get(Mallorca..'Mallorca:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'℘︙عدد جهاتك المضافه هنا *~ '..(Redis:get(Mallorca.."Mallorca:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
local CmdStart = '*\n℘︙أهلآ بك في بوت '..(Redis:get(Mallorca.."Mallorca:Name:Bot") or "مالوركا")..
...
{
{text = 'تعيين قناة الاشتراك ℘',type = 'text'},{text = 'قناة الاشتراك ℘',type = 'text'},{text = 'حذف قناة الاشتراك ℘',type = 'text'}
},
{
